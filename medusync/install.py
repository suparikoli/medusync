...
def after_install():
	...
	# Deliberately no fields on any doctype: Medusa ids live in Medusync
	# Link and the sync decision in Medusync Exclusion / Inclusion.
...
def after_migrate():
	...
	"""
	from medusync import defaults, drift, sync_field
